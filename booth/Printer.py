...
# This is pretty much a 1:1 direct Python port of the Printer
...
# needed.  This should simplify porting existing Printer-based
...
class Printer(Serial):
    ...
    def writeBytes(self, *args):
        ...
        for arg in args:
            super(Printer, self).write(chr(arg))
